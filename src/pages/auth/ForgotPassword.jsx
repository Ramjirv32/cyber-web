...
export default function ForgotPassword() {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      const response = await axios.post(`https://b-gray-phi.vercel.app/forgot-password`, { email });
  ...
  const handleVerifyOTP = async (e) => {
    ...
    try {
      const response = await axios.post(`https://b-gray-phi.vercel.app/verify-otp`, { email, otp });
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`https://b-gray-phi.vercel.app/reset-password`, payload);
